DROP DATABASE IF EXISTS BALLERINA_DB;
CREATE DATABASE BALLERINA_DB;
CREATE USER IF NOT EXISTS 'ballerina'@'%' IDENTIFIED BY 'ballerina';
ALTER USER 'ballerina'@'%' IDENTIFIED WITH mysql_native_password BY 'ballerina';
GRANT ALL ON BALLERINA_DB.* TO 'ballerina'@'%';
USE BALLERINA_DB;
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (145,'John','Russell','john.russell@sqltutorial.org','','1996-10-01',15,14000.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (146,'Karen','Partners','karen.partners@sqltutorial.org','','1997-01-05',15,13500.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (176,'Jonathon','Taylor','jonathon.taylor@sqltutorial.org','','1998-03-24',16,8600.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (177,'Jack','Livingston','jack.livingston@sqltutorial.org','','1998-04-23',16,8400.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (178,'Kimberely','Grant','kimberely.grant@sqltutorial.org','','1999-05-24',16,7000.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (179,'Charles','Johnson','charles.johnson@sqltutorial.org','','2000-01-04',16,6200.00,100,8);
...
DELIMITER &&  
CREATE PROCEDURE getAllDependents ()  
BEGIN  
...
DELIMITER &&  
CREATE PROCEDURE getAllRegions ()  
BEGIN  
    SELECT * FROM regions;    
END &&  
DELIMITER ;  
...
DELIMITER &&  
CREATE PROCEDURE getEmployeesById (IN p_employee_id INT)  
BEGIN  
...
DELIMITER &&  
CREATE PROCEDURE updateEmployeeSalary (IN p_employee_id INT,IN p_salary DECIMAL(10,2))  
BEGIN  
